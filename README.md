...
- `LEAN_DIAGNOSTICS_TIMEOUT`: Max seconds to wait for diagnostics before returning partial results (default: 30).
- `LEAN_DIAGNOSTICS_POLL_INTERVAL`: Poll interval in seconds for diagnostics readiness (default: 0.05).
